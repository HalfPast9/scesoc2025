...
export function HeroSectionWithBeamsAndGrid() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="rounded-[24px] border border-neutral-200 bg-transparent p-2 dark:border-neutral-700 dark:bg-transparent">
          <Image
            src="/SCESoc_Logo_Yellow_White_Vertical.png"
            alt="header"
            width={1920}
            height={1080}
